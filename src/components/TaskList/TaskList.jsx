      ...
      {tasks.map(task => (
        ...
        >
          <div className="flex items-center gap-4 flex-1">
            <div className="relative">
              <input
                ...
                className={`h-5 w-5 rounded-lg border-2 transition-colors duration-300 cursor-pointer ${
                  darkMode 
          ...
          <button
            ...
            className={`p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 transform hover:scale-110 ${
              darkMode
